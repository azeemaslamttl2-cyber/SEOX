...
export default function TechSeoLayout() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip bg-[#f7f3f4] text-[#2d2b6f]">
      <div className="pointer-events-none fixed inset-0 -z-10">
        <div className="absolute -top-40 left-1/3 h-[600px] w-[700px] rounded-full bg-[#f5d8d6]/60 blur-[160px]" />
        <div className="absolute bottom-0 right-1/4 h-[500px] w-[500px] rounded-full bg-[#c9d3ff]/40 blur-[160px]" />
      </div>
