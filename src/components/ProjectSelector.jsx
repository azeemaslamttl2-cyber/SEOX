  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-white/10 bg-white/[0.03] px-4 py-2 text-sm font-medium text-white transition hover:bg-white/[0.06]"
      >
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 w-72 overflow-hidden rounded-xl border border-white/10 bg-ink-800/95 p-1.5 shadow-2xl backdrop-blur-2xl z-50">
          ...
          <div className="max-h-56 overflow-y-auto no-scrollbar">
            ...
            {projects.length === 0 && (
              <p className="px-3 py-4 text-sm text-white/45">No projects found.</p>
            )}
          </div>
