...
function canCheckDomain(domain) {
...
export default function ExpiredDomainFinder() {
  ...
  function handleCheck() {
    ...
    setRemovedCount(rejected.length);
    setDomains(normalized.join("\n"));
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-[#0d1117]">
        ...
        <div className="flex items-center justify-between border-b border-white/[0.06] px-5 py-3">
          <div className="flex items-center gap-4">
            ...
            <button className="flex items-center gap-1.5 text-[11px] text-white/30 hover:text-white/50 transition">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-white/[0.08] bg-white/[0.02] px-3 py-1.5 text-[11px] font-semibold text-white/40 hover:text-white/60 transition disabled:opacity-30 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-1.5 text-[11px] font-bold text-white shadow-md shadow-emerald-500/15 transition hover:bg-emerald-400 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              {checking ? (
                <>
